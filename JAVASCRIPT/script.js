window.onload = (event) => {
  ...
  function getDataFile (){
    ...
    projectDataFile = "/projectdata-" + language + ".json";
    ...
    .then((data) => {
      ...
      switch (document.body.getAttribute("page")) {
        ...
        case "splash":
          ...
          let lgButtons = [engButton, frButton];
          ...
          lgButtons.forEach(button => {
            button.addEventListener('click', function() {
              ...
              // check if we came from the about page (rt)
        ...
        case "gallery":
          ...
          let displayedProjectId = urlGallery.get("pr") || 0;
          let displayedProject = projects[displayedProjectId];            
          ...
          langButton.addEventListener("click", (event) => {
            ...
            const newUrl = `/gallery.html?lg=${lgGallery}&pr=${displayedProjectId}`;
            langButton.href = newUrl; 
          });

          // pass the language var in the url
          let aboutButtons = [document.getElementById('logo'), document.getElementById('name'), document.getElementById('alias')];
          aboutButtons.forEach(button => {
            const newUrl =`/about.html?lg=${lgGallery}&pr=${displayedProjectId}`;
            button.href  = newUrl;
          });
