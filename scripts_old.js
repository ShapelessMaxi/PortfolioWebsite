$(document).ready(function() {
    ...
    var uiElements = $("#artwork-viewer-border, #artwork-viewer-bg, #artwork-title, .artwork-button-box, .artwork-viewer, .artwork-text, .artwork-footnote-box");
    projects.hide();
    uiElements.hide();
    ...
    // hide text boxes
    textboxes= $("#textbox-statement, #textbox-bio");
    textboxes.hide();
    // collapsible contact text boxes
    $(".textbox-title").click(function() {

        // Add or remove the 'textbox-active' class on the clicked element
        if ($(this).hasClass("textbox-active")) {
            $(this).removeClass('textbox-active');
            
            // Hide corresponding textbox based on the ID of the clicked element
            if ($(this).attr("id") === "textbox-menu-statement") {
                $("#textbox-statement").hide();    
                $('#statement-box').css('overflow-y ', 'hidden');

            } else if ($(this).attr("id") === "textbox-menu-bio") {
                $("#textbox-bio").hide();
                $('#statement-box').css('overflow-y ', 'hidden');
            };
            ...
            $(this).siblings('.img-contact-button').addClass("clicked-animation");
            $(this).siblings('.img-contact-button').removeClass("hover-animation");
            // $(this).parent().addClass("clicked-animation");

            // Show corresponding textbox based on the ID of the clicked element
            if ($(this).attr("id") === "textbox-menu-statement") {
                $("#textbox-bio").hide();
                $("#textbox-statement").show();
    ...
    // button hover animation for textboxes
    $(".textbox-title").mouseenter(function() {
        // Trigger animation when mouse enters the .textbox-title
        $(this).siblings(".img-contact-button").addClass("hover-animation");
    }).mouseleave(function() {
